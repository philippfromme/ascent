...
class AppHeader extends LitElement {
  ...
  constructor() {
    super();
    this.view = ["timeline", "summits"].includes(localStorage.getItem("ascent-dashboard-view")) ? localStorage.getItem("ascent-dashboard-view") : "cards";
  }
